...
export type BlackPowderWeaponProps = {
  _id: string | null
  _typename: 'BlackPowderWeapon' | null
  description: Document | null
  name: string | null
  specialRules: SpecialRuleModuleProps[]
}

const BlackPowderWeapon: React.FC<BlackPowderWeaponProps> = (props) => {
...
export default BlackPowderWeapon
